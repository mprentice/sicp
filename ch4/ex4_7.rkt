...
(define (first-let*-binding exp) (list (caadr exp)))

(define (rest-let*-binding exp) (cdadr exp))

(define (let*-body exp) (let-body exp))

(define (let*->nested-lets exp)
  (if (null? (rest-let*-binding exp))
      (make-let (first-let*-binding exp) (let*-body exp))
      (make-let (first-let*-binding exp)
                (list (let*->nested-lets (make-let* (rest-let*-binding exp)
                                                    (let*-body exp)))))))
