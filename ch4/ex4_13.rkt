...
(define (eval exp env)
  (cond ((self-evaluating? exp) exp)
        ...
        ((make-unbound!? exp) (unbind-variable! (unbind-symbol exp) env))
...
;;; Ex 4.13
;;; Only strip the first binding encountered (innermost binding)

(define (make-unbound!? exp) (tagged-list? exp 'make-unbound!))

(define (unbind-symbol exp) (cadr exp))
